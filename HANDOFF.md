...
- **Ultimo passo rimasto**: riattivare Pages. Mergiando questo branch in `main` il workflow parte e riattiva Pages da solo; in alternativa Settings > Pages > Source. Poi test end-to-end su un link vero (accetta/rifiuta, doppio tap → deve restare idempotente).
